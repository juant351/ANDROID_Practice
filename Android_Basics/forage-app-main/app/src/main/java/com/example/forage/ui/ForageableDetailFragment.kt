...
import com.example.forage.ui.viewmodel.ForagesViewModelFactory
...
class ForageableDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Observe a forageable that is retrieved by id, set the forageable variable, and call the bind forageable method
